...
- [ ] 🔴🔴 **SONUÇ/FİRMA VERİSİ — İKİ ŞEMA ÇATIŞMASI (8 Tem, en kritik veri bloğu):** "gerçek sonuç verisi" (kim kazandı/tenzilat/yüklenici — firma-analiz + rekabet zekâsının temeli) çekilemiyor çünkü `ihale_sonuclari` için **iki uyumsuz tasarım** var:
