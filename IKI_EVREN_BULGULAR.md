...
| B5 | `v1-kurum-analiz.html` kurum_ozet/kurum_dt_ozet/analiz_pivot + 4 sorgu | isim-anahtar | KURUM=ad `ilike('idare')` → birleşmiş kurumun tek varyantı | 3 RPC'ye p_detsis + frontend detsis geçir *(kullanıcının açık isteği)* | ~0.5g |
