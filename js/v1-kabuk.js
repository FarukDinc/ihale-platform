...
(() => {
  ...
  ray.innerHTML =
    ...
    + '@media(max-width:1150px){.v1-dunya-sekme span{display:none;}.v1-dunya-sekme{padding:8px 10px;}}'
    + '@media(max-width:900px){.v1-dunya-sekme{padding:7px 9px;}.v1-paket-ad{display:none;}}'
